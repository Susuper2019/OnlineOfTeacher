...
<body class="hold-transition skin-purple sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    <thead>
                    <tr>
                        <%--<th class="text-center sorting">课程编号</th>--%>
                        <th class="text-center sorting">课程名称</th>
                        <th class="text-center sorting">主讲教师工号</th>
                        <th class="text-center sorting">主讲教师姓名</th>
                        <th class="text-center sorting">父单元名称</th>

                        <th class="text-center sorting">子单元名称</th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${sonunits}" var="sonunits">
                        <tr>
                            <%--<td>${course.cid}</td>--%>
                            <td>${course.cname}</td>
                            <td>${teacher.tuesr}</td>
                            ...
                            <td>${sonunits.suarticle}</td>

                            <%--<td class="text-center">--%>
                                <%--<a href="<%=basePath%>/page/unitInsert.jsp?id=${basiccarEntityList.bid}"><button type="button" class="btn bg-olive btn-xs">查看/开设子单元</button></a>--%>
                            <%--</td>--%>
                        </tr>
                    </c:forEach>
                    </tbody>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">设置新的子单元</div>
                    <div class="row data-type">
                        <div class="form-group">
                            <label>单元名称</label>
                            <textarea class="form-control" rows="3" placeholder="Enter ..." id="suarticle" name="suarticle"></textarea>
                        </div>
                        <%--${param.id}--%>
                        <input type="hidden" class="form-control" value="${param.id}" name="uid" id="uid">
                        <input type="hidden" class="form-control" value="${param.cid}" name="cid" id="cid">
                        <input type="hidden" class="form-control" value="${param.tid}" name="tid" id="tid">
    ...
    <script>
        ...
        function insert(){
            ...
            var suarticle = document.getElementById("suarticle").value;
            ...
            document.formTest.action="<%=basePath%>/SonUnitController/insertSonUnit?suarticle="+suarticle+"&cid="+cid+"&uid="+uid+"&tid="+tid;
