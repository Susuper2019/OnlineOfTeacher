...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form method="post" name="formTest" action="<%=basePath%>/UnitpapertestController/insertUnitPaper">
                <!--订单信息-->
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="题目"  name="title">
                        </div>

                        <div class="col-md-2 title">正确选项</div>
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 40%;" name="reallyopt">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="选项A"  name="opta">
                        </div>

                        <div class="col-md-2 title">选项B</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="选项B"   name="optb">
                        </div>

                        <div class="col-md-2 title">选项C</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="选项C"   name="optc">
                        </div>

                        <div class="col-md-2 title">选项D</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="选项D"  name="optd">
                        </div>

                        <input type="hidden" class="form-control" value="${param.uid}"  name="uid">
                    </div>
                    <!--工具栏-->
            ...
            <form method="post" action="<%=basePath%>/UploadController/save" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="file">为本章上传学习资料</label>
                    <input type="file" name="multipartFile" id="file" style="width: 50%" >
                    <input type="hidden" name="uid"  value="${param.uid}"   style="width: 50%"  />
                    <br />
                    <input type="submit" value="上传" class="btn bg-olive btn-lg"></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<%=basePath%>/UploadController/downloadFile?uid=${param.uid}"><button type="button" class="btn bg-olive btn-lg">下载学习资源</button></a>
                </div>
            </form>
            ...
            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                ...
                <tbody>
                <c:forEach items="${unitpapertests}" var="unitpapertests">
                    <tr>
                            <%--<td>${unitpapertests.cname}</td>--%>
                        <td>${unitpapertests.title}</td>
                        <td style="<c:if test="${unitpapertests.reallyopt==1}">color: red;</c:if>">
                                ${unitpapertests.opta}
                        </td>
                        <td style="<c:if test="${unitpapertests.reallyopt==2}">color: red;</c:if>">
                                ${unitpapertests.optb}
                        </td>
                        <td style="<c:if test="${unitpapertests.reallyopt==3}">color: red;</c:if>">
                                ${unitpapertests.optc}
                        </td>
                        <td style="<c:if test="${unitpapertests.reallyopt==4}">color: red;</c:if>">
                                ${unitpapertests.optd}
                        </td>
...
<script>
    ...
    function insert(){
        ...
        document.formTest.action="<%=basePath%>/UnitpapertestController/insertUnitPaper?uid="+uid+"&reallyopt="+reallyopt+"&title="+title+"" +
